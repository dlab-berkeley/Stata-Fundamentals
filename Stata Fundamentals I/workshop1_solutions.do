...
(2) No
(3) Don’t know
(If you ran the command above without any errors, the answer should be Yes)
***/
...
(5) clear all // make sure environment is clear before reading in new data <-- CORRECT ANSWER
***/
...
(2) tab race c_city, row <--- CORRECT ANSWER
...
(1)  gen full_time=hours>=40 <--- CORRECT ANSWER
