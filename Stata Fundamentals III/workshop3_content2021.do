...
Break at 10:11 am, Return at 10:21am
...
drop if childage==. & child_num>0 & child_num<. 
drop if (child_num==0 | child_num==.) & childidcode>1 & _merge!=2

count 
unique idcode
br idcode childidcode
...
Break at 11:15, Return at 11:19
